...
author: CodeGen
description: |
  A tooltip is a small, informative message or hint that appears when a user hovers their mouse over an object,
  such as a button, image, or hyperlink, on a website.
  See how to create a simple but powerful tooltip directive using the `@angular/cdk` and `OverlayModule`.
tags: ["@angular/cdk", "Angular", "Angular 16"]
thumbnail: https://codegen.studio/wp-content/uploads/2022/08/cdk-320x180.png
repository: tooltip
---
