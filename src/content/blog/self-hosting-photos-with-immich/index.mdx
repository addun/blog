...
By now our home lab has a solid spine: a [Docker host](/blog/Kq7Bv3) and, from [part 3](/blog/Wm4Tn8), network-wide DNS plus a Caddy reverse proxy handing out tidy `*.home.arpa` addresses. Time to put something genuinely useful on it - something you'd otherwise pay a subscription for.
...
Your home lab's _config_ is already safe in Git. But your photos are not config - they're irreplaceable, and this is exactly the data the SATA backup drive from [part 1](/blog/yaqjpy) was for. Two folders hold everything Immich cares about:
