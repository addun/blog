    ...
    <form [formGroup]="form">
      <div class="relative">
        ...
        <button
          ...
          type="submit"
          class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-hidden focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Add
        </button>
      </div>
      ...
      @for (todo of todos(); track $index) {
        <li class="flex justify-between">
          ...
          <button
            ...
            type="button"
            class="ml-10 text-blue-700 border border-red-700 hover:bg-red-700 hover:text-white focus:ring-4 focus:outline-hidden focus:ring-red-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:focus:ring-red-800 dark:hover:bg-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <!-- prettier-ignore -->
